...
class OrganizationUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organization_user" do
    assert_difference('OrganizationUser.count') do
      post organization_users_url, params: { organization_user: { organization_id: @organization_user.organization_id, user_id: @organization_user.user_id } }, as: :json
    end
  ...
  test "should update organization_user" do
    patch organization_user_url(@organization_user), params: { organization_user: { organization_id: @organization_user.organization_id, user_id: @organization_user.user_id } }, as: :json
    assert_response 200
  end
