...
ActiveRecord::Schema.define(version: 2021_01_28_025255) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.index ["workflow_run_id"], name: "index_projects_on_workflow_run_id"
    t.index ["workflow_template_id"], name: "index_projects_on_workflow_template_id"
  end
